...
"""Extended error detail on a query-selection rejection: a where-clause query
that is denied its primary-index fallback surfaces its ``result_code`` (and any
``sub_code``) on the raised exception under a verbose Behavior."""
